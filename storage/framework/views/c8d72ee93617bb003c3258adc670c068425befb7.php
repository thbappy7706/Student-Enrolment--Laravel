...
<h1 class="bp">  WELCOME TO DIU STUDENT ENROLLMENT SYSTEM </h1>
            ...
            <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
                <div class="card col-lg-4 mx-auto">
                    <div class="card-body px-5 py-5">
                        ...
                        <!---FORM CONTROLLING LOGIC-->

                        <form  method="post" action="<?php echo e(url('/studentlogin')); ?>">
...
<?php /**PATH C:\xampp\htdocs\stuenrollment\resources\views/student_login.blade.php ENDPATH**/ ?>