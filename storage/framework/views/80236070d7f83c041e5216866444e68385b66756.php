...
<div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="<?php echo e(URL::to('/')); ?>"><img height="50px" width="4px" src="/images/p.png" alt="Logo"></a>
        </div>
        ...
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(URL::to('/st_setting')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(URL::to('/st_profile')); ?>">
                            <i class="mdi mdi-gauge menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(URL::to('/st_logout')); ?>">
                            <i class="mdi mdi-gauge menu-icon"></i>
...
<?php /**PATH C:\xampp\htdocs\stuenrollment\resources\views/s_layout.blade.php ENDPATH**/ ?>